        ...
        if user_id:
            ...
            if student:
                assignment = (
                    ...
                    .sudo()
                    .search([("model", "=", "op.assignment")])
                )
                if assignment:
                    total_assignments = (
                        request.env["op.assignment"]
                        .sudo()
                        .search_count(
                            [
                    ...
                    total_submissions = (
                        request.env["op.assignment.sub.line"]
                        .sudo()
                        .search_count(
                            [("student_id", "=", student.id), ("state", "=", "submit")]
                        )
                    )
                ...
                library = (
                    request.env["ir.model"]
                    .sudo()
                    .search([("model", "=", "op.media.movement")])
                )
                if library:
                    assigned_books = (
                        request.env["op.media.movement"]
                        .sudo()
                        .search_count(
